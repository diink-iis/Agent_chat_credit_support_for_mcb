...
def make_judge(model: str = "GigaChat-Max"):
    """
    ...
    Судья — GigaChat-Max (самая мощная модель линейки) и независим от модели
    агента (Pro), что снижает риск «само себя хвалит». Модель явная, не зависит
    от дефолта фабрики.
    """
